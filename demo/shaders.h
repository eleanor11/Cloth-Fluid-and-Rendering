...
void MyDrawCloth(const Vec4* positions, const Vec4* colors, const Vec4* normals, const Vec3* uvs, const int* indices, int numTris, int numPositions, int cshader_mode, float cshader_kd, float cshader_a, float cshader_fresnelPowRow, float cshader_fresnelPowCol, float expand = 0.0f, bool twosided = true, bool smooth = true);
/*add end*/
